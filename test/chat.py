import nltk
# Uncomment the lines below to download the required NLTK resources
# nltk.download('punkt')
...
# Open the intents.json file with UTF-8 encoding
...
for doc in documents:
    # initializing bag of words and output row
    bag = []
